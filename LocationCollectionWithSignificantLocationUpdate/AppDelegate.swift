...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
       ...
       _ = NotificationHelper.sharedNotificationManager
        
            #if REGION
                
                let locationManger = LocationManagerRegionMonitoring.sharedManager
                locationManger.setupLocationManager()
                if let launchOptions = launchOptions {
                    if launchOptions[UIApplicationLaunchOptionsKey.location] != nil {
                        CommonHelper.writeToFile("Did Finish Launching With launchOptions Key Geo Fencing ")
                        locationManger.appMovedToBackground()
                        NotificationHelper.sharedNotificationManager.addLocalNotification("App Woke up from Region Monitoring", subtitle: "", message: "")
                    }
                }
    ...
    func applicationWillTerminate(_ application: UIApplication) {
        ...
        #if REGION
            LocationManagerRegionMonitoring.sharedManager.appWillTerminate()
            #endif
        ...
        CommonHelper.writeToFile("Application Will Terminate ")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "LocationCollectionWithSignificantLocationUpdate")
